...
@section('content')
    <div id="both">
        <div>
            <p class="text-xl font-semibold text-gray-700 dark:text-gray-200">Users</p>
            @foreach ($users as $user)
                <div class="px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800 grid grid-cols-4 mt-6">
                    <div>
        ...
        <div>
            <p class="text-xl font-semibold text-gray-700 dark:text-gray-200">Taches</p>
            {{-- Modal button --}}
            ...
            <a href="/incubator/startups/{{$user->startup_id}}/documents"
                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                <span>Documents</span>
            ...
            <div>
                ...
                <div class="mt-4 min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    {{-- Edit --}}
                    <a href="/incubator/tasks/{{ $task->id }}/edit"
                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                        aria-label="Edit">
                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                            viewBox="0 0 20 20">
