                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-full"
                                            src="https://itsocial.fr/wp-content/uploads/2019/02/iStock-874722684.jpg" alt=""
                                            loading="lazy" />
                     ...
                     10x Developer
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    {{-- Edit --}}
                                    <a href="/incubator/startups/edit/{{ $startup->id }}"
                            ...
                            <td>
                                <a href="/incubator/startups/show/{{ $startup->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-6" fill="none"
