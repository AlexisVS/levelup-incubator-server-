...
<div class="overflow-hidden sm:rounded-lg">
  <div class=" py-5 sm:px-6">
    <h3 class="text-2xl my-6 leading-6 font-semibold text-gray-900 dark:text-gray-200">Goal {{ $goal_template->name }} Information</h3>
  ...
  <div class="">
    <dl>
      <div class="px-4 py-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-800 dark:text-gray-200 mt-6 mb-4">Goal tasks include :</dt>
